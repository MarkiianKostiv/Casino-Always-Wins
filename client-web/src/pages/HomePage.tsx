...
export const HomePage = () => {
  ...
  return (
    <Wrapper>
      <div
        className='relative flex flex-col items-start justify-around w-full h-full p-8'
        style={{
      ...
      >
        ...
        <div className='relative z-10 flex w-full gap-5'>
          <aside className='bg-secondary-dark w-1/2 p-4 rounded'>
            <h1 className='text-white'>{t("try_lack")}</h1>
            <p className='text-white'>{t("description")}</p>
          </aside>
          <div className='bg-secondary-dark text-black w-1/2 p-4 rounded'>
            <SpinningWheel />
          </div>
        </div>
        <div
        ...
        >
          <div
            ...
            bg-[#5d5a5a] bg-opacity-30 backdrop-blur-sm rounded-xl z-10`}
          >
